...
const Navbar = ({ isDark }: Props) => {
  ...
  const navBg = isDark == "true" ? "url('/images/blur.jpeg')" : "#00000023";
  return (
    <header style={{ background: navBg }} className={`min-w-full z-50 ${isDark == "true" ? "text-gray-100 bg-[#ffffff4f]" : "text-gray-800 bg-[#00000023] absolute"} bg-cover bg-center py-10 px-4 md:px-0 top-0`}>
